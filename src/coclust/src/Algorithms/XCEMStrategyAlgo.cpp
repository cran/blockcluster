...
/**
 * @file XCEMStrategyAlgo.cpp
 * @brief Implements XCEM strategy algorithm class XCEMStrategyAlgo derived from IAlgo.
 */

#include "XCEMStrategyAlgo.h"

bool XCEMStrategyAlgo::run()
{
#ifdef COVERBOSE
  std::cout<<"Running XCEM Strategy Algorithm.."<<"\n";
#endif
