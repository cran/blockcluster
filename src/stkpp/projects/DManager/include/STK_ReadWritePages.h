...
class ReadWritePages
{
  ...
  public:
    ...
    **/
     ...
     */
    inline IPage const* p_page( Integer const& pos) const
    ...
    /** @brief get a page of option.
      ...
      *  @return the page at the position pos
      */
     inline IPage* p_page( Integer const& pos)
     { return pages_.at(ContPage::size_type(pos));}
      ...
      *  @return the page at the position pos
      */
     inline IPage const* operator[]( Integer const& pos) const
     { return pages_.at(ContPage::size_type(pos));}
     ...
     /** @brief get a page of option.
       ...
       *  @return the page at the position pos
       */
     inline IPage* operator[]( Integer const& pos)
     { return pages_.at(ContPage::size_type(pos));}
