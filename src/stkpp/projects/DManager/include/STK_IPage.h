...
class IPage
{
  public:
     ...
     **/
    inline Option const& option(Integer const& pos) const
     ...
     *  @return the pos-th Option
     **/
    inline Option& option(Integer const& pos)
    { return options_.at(ContOption::size_type(pos));}
     ...
     *  @return the pos-th Option
     */
    inline Option const& operator[](Integer const& pos) const
    { return options_.at(ContOption::size_type(pos));}
     ...
     *  @return the pos-th Option
     */
    inline Option& operator[](Integer const& pos)
    { return options_.at(ContOption::size_type(pos));}
    ...
    inline virtual bool validate()
    { return true; }

    /** validate the page. Check if the options are coherent. */
    inline virtual IPage* clone() const
