...
/** @file STK_MatrixLowerTriangular.cpp
 *  @brief In this file we implement the MatrixLowerTriangular class.
 **/
 ...
 **/
MatrixLowerTriangular::MatrixLowerTriangular( Range const& I, Range const& J)
                                            : _ITArray2DType(I, J)
                                            , defaultConst_(Real())
{
 ...
 **/
MatrixLowerTriangular::MatrixLowerTriangular( Range const& I
                                            , Range const& J
                                            , Real const& v
                                            )
                                            : _ITArray2DType(I, J)
 ...
 **/
MatrixLowerTriangular::MatrixLowerTriangular( const MatrixLowerTriangular &T
                                            , bool ref
                                            )
 ...
 **/
MatrixLowerTriangular::MatrixLowerTriangular( const _ITArray2DType& T
                                            , Range const& I
                                            , Range const& J
                                            )
 ...
 *  @param J range of the Cols to wrap
 **/
MatrixLowerTriangular::MatrixLowerTriangular( Real** q
                                            , Range const& I
                                            , Range const& J
                                            )
...
MatrixLowerTriangular::~MatrixLowerTriangular()
{ ;}
 ...
 *  @param T the container to copy
 **/
MatrixLowerTriangular& MatrixLowerTriangular::operator=(const MatrixLowerTriangular &T)
{
  // Resize if necessary.
