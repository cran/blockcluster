...
#' "asp": If this is set to FALSE the original aspect ratio is not conserved. In this case, R graphics will display the data
...
#' colcustered data and distributions and mixtire densitities for coclusters resplectively. Default is "cocluster" plot.
#'
#' 
